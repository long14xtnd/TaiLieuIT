...
public class KMeans {
	...
	public static class Map extends MapReduceBase implements
		...
		public void map(LongWritable key, Text value,
			...
			double d, mind = Double.MAX_VALUE, nearest_center = mCenters.get(0);
	...
	public static void run(String[] args) throws Exception {
		//IN = args[0];
		//OUT = args[1];
		//IN = "hdfs://localhost:19000/test/";
		IN = "D:/Hadoop/test/input/";
		//OUT = "hdfs://localhost:19000/output";
		OUT = "D:/Hadoop/test/output";
		String input = IN;
		...
		while (isdone == false) {
			...
			if (iteration == 0) {
				...
				//Path hdfsPath = new Path("D:/Hadoop/test/input/centroid.txt");
